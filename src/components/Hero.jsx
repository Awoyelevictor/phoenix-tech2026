    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <motion.p
            className="text-lg md:text-xl text-textSecondary font-light max-w-xl mx-auto md:mx-0 mb-10 leading-relaxed"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <a href="#projects" className="px-8 py-4 bg-accent text-white rounded-xl font-medium tracking-wide hover:bg-accent/90 transition-colors">
              View My Work
            </a>
            <a href="#contact" className="px-8 py-4 border border-white/20 text-textPrimary rounded-xl font-medium tracking-wide hover:bg-white/5 transition-colors">
              Contact Me
            </a>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.div
            className="absolute w-72 h-72 lg:w-96 lg:h-96 rounded-full bg-gradient-to-tr from-indigo-600 to-purple-400 blur-2xl opacity-40"
            animate={{
              scale: [1, 1.1, 1],
              rotate: [0, 90, 0],
            }}
          ...
          {/* Profile Image */}
          <div className="relative z-10 w-64 h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-charcoal shadow-2xl">
            <img
